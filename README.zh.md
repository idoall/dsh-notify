...
- **精确跳到那一轮**：点一张卡片会打开对应会话，并滚动到（短暂高亮）产生该通知的那一轮。**只有真的跳过去了卡片才会消失**，所以跳不过去不会被悄悄吞掉：会话已经不在了（被删、被归档、或不在本页列表里）会在卡片上写「这个会话已经不在了，无法打开」；只是这次失败会写「没能打开这个会话，再点一次试试」，再点一次就是重试；自测卡本来就没有会话，点了就安静关闭。
